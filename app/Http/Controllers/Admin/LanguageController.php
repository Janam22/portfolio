...
class LanguageController extends Controller
{
    ...
    {       $language = SystemSetting::where('key', 'system_language')->exists();
        if(!$language){
            Helpers::insert_business_settings_key('system_language','[{"id":1,"direction":"ltr","code":"en","status":1,"default":true}]');
        }
        return view('admin-views.system-settings.language.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        SystemSetting::updateOrCreate(['key' => 'system_language'], [
            'value' => $lang_array
        ]);

        SystemSetting::updateOrCreate(['key' => 'language'], [
    ...
    public function update_status(Request $request)
    {
        ...
        $businessSetting = SystemSetting::where('key', 'system_language')->update([
            'value' => $lang_array
        ]);
    ...
    public function update_default_status(Request $request)
    {
        ...
        SystemSetting::where('key', 'system_language')->update([
            'value' => $lang_array
        ]);
