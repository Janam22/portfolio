...
class UpdateController extends Controller
{
    ...
    public function update_software(Request $request)
    {
        ...
        Helpers::insert_business_settings_key('pm_maximum_orders',1);
        Helpers::insert_business_settings_key('order_confirmation_model','professionalman');
        Helpers::insert_business_settings_key('popular_service',1);
        Helpers::insert_business_settings_key('new_service',1);
        Helpers::insert_business_settings_key('most_reviewed_services',1);
        ...
        //Version 5.0
        Helpers::insert_business_settings_key('canceled_by_professionalman',0);
        Helpers::insert_business_settings_key('timeformat','24');
        // Helpers::insert_business_settings_key('language','en');

        Helpers::insert_business_settings_key('toggle_home_external', 0);
        Helpers::insert_business_settings_key('toggle_pm_registration', 0);
        ...
        if(is_numeric(env('SOFTWARE_VERSION')) && env('SOFTWARE_VERSION') <= '5.1'){
            ProductLogic::update_service_ratings();
        }
        ...
        Helpers::insert_business_settings_key('home_service', '1');
        ...
        try{
            ...
            foreach($data as $key => $value){
                    ...
                    if ($key == 'twilio_sms') {
                        ...
                        $additional_data = [
                            'status' => data_get($decoded_value,'status',null),
                            'auth_token' => data_get($decoded_value,'auth_token',null),
                        ];
