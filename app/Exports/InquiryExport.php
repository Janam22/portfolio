...
class InquiryExport implements  FromView, ShouldAutoSize, WithStyles,WithColumnWidths ,WithHeadings, WithEvents, WithColumnFormatting
{
    ...
    {
        return view('file-exports.inquiry-list', [
            'data' => $this->data,
        ]);
    }
    ...
    public function styles(Worksheet $sheet) {
        ...
        return [
            ...
            'A1:J'.$this->data['inquiries']->count() +5 => [
                'borders' => [
                    'allBorders' => [
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $event->sheet->getStyle('A4:J'.$this->data['inquiries']->count() +5)
                    ->getAlignment()
                    ->setHorizontal(Alignment::HORIZONTAL_CENTER)
                    ->setVertical(Alignment::VERTICAL_CENTER);
