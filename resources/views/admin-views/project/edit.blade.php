...
@section('title',translate('messages.Update_Project'))
            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h2 class="page-header-title text-capitalize">
                        ...
                        <span>
                            {{translate('messages.Project_Update')}}
                        </span>
                    </h2>
                </div>
            </div>
                        ...
                        @if ($language)
                            <div class="lang_form" id="default-form">
                                ...
                                <div class="form-group mb-0">
                                        ...
                                        <select name="service_id" id="service_id"
                                            ...
                                            @foreach ($services as $service)
                                                <option value="{{ $service['id'] }}" {{ $service->id == $project->service_id ? 'selected' : '' }}>{{ $service['name'] }}
                                                </option>
                                            @endforeach
                                        </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="link" class="form-control" value="{{$project?->getRawOriginal('link')}}"
                            ...
                            <div class="card-body">
                                <div id="default-form">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name[]" class="form-control" value="{{$project?->getRawOriginal('name')}}"
                                            placeholder="{{ translate('messages.new_project') }}" >
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="input-label"
                                            for="exampleFormControlInput1">{{ translate('messages.project_link_(optional)') }}</label>
                                        <input type="text" name="link" class="form-control" value="{{$project?->getRawOriginal('link')}}"
                                            placeholder="{{ translate('messages.project_link') }}" >
                                    </div>
                                </div>
                            ...
                            <div class="d-flex flex-column align-items-center gap-3">
                                ...
                                <div class="image-box">
                                    <label for="image-input" class="d-flex flex-column align-items-center justify-content-center h-100 cursor-pointer gap-2">
                                        ...
                                        src="{{$project['image_full_url'] }}" alt="Upload Icon">
